...
export class SettingsStore {
  ...
  get value(): AgentSettings {
    return {
      ...
      customEndpoints: this.#value.customEndpoints.map((endpoint) => ({
        ...endpoint,
  ...
  #read(): AgentSettings {
    try {
      ...
      if (parsed.autoApproveEdits === true && parsed.permissionMode === undefined)
        parsed.permissionMode = "allow-edits";
