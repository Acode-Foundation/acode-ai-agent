...
export const settingsSchema = z.object({
	...
	subagentMaxConcurrent: z.number().int().min(1).max(4).catch(2),
	subagentTimeoutMs: z.number().int().min(30_000).max(1_200_000).catch(480_000),
	subagentDefaultAsync: z.boolean().catch(false),
