...
export const customModelsSchema = z
  .record(z.string(), z.array(z.string().min(1).max(120)))
  .catch({});
...
export const settingsSchema = z
  .object({
    ...
    compactionReserveTokens: z
      ...
      .min(1_024)
      .max(262_144)
      .catch(DEFAULT_COMPACTION_SETTINGS.reserveTokens),
    compactionKeepRecentTokens: z
      .number()
      .int()
      .min(1_024)
      .max(262_144)
      .catch(DEFAULT_COMPACTION_SETTINGS.keepRecentTokens),
